...
class Read {
    ...
    Read(this.pullup, this.pulldown, this.delay, this.virtual);
}
 ...
 * @author Eric Tsai
 */
abstract class Analog implements ForcedDataProducer {
    /**
