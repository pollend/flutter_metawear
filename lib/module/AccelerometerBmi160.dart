 ...
 * @author Eric Tsai
 */
abstract class StepDetectorDataProducer with AsyncDataProducer implements Configurable<StepConfigEditor> {
 ...
 * @author Eric Tsai
 */
abstract class StepCounterDataProducer with ForcedDataProducer implements Configurable<StepConfigEditor> {
    /**
...
class FlatHoldTime {
    ...
    static List<FlatHoldTime> _entires = [
        FHT_0_MS, FHT_640_MS, FHT_1280_MS, FHT_2560_MS
    ];

    static List<double> get delays => _entires.map((f) => f.delay);
}
/**
 * Configuration editor specific to BMI160 flat detection
 * @author Eric Tsai
 */
abstract class FlatConfigEditor extends AccelerometerBosch.FlatConfigEditor<FlatConfigEditor> {
 ...
 * @author Eric Tsai
 */
abstract class SignificantMotionDataProducer with MotionDetection, AsyncDataProducer implements Configurable<SignificantMotionConfigEditor> { }

/**
 * Extension of the {@link AccelerometerBosch} interface providing finer control of the BMI160 accelerometer features
 * @author Eric Tsai
 */
abstract class AccelerometerBmi160 implements AccelerometerBosch.AccelerometerBosch {
