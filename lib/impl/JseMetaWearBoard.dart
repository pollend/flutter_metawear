...
enum RouteType {
 ...
 class BoardInfo {
    final Map<ModuleType, ModuleInfo> moduleInfo= {};
...
class PersistentData {
    int routeIdCounter;
    BoardInfo boardInfo;
    final Map<int, RouteInner> activeRoutes = {};
    final Map<int, ObserverInner> activeEventManagers = {};
    final Map<String, DataTypeBase> taggedProducers = {};
    final Map<Type, Module> modules = = {};
...
class RouteInner implements Route {

  final Uint8List eventCmdIds;
  final List<DeviceDataConsumer> consumers;
  final Uint8List dataprocessors;
  final HashSet<String> processorNames;
  final int id;
  bool active;
